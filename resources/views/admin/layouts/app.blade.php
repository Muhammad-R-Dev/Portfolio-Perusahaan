...
<head>
	...
	<!-- CSS Styles (dipakai bersama semua halaman admin) -->
	<style>
	...
	{{-- CSS khusus tiap halaman (opsional), didaftarkan lewat @push('styles') di masing-masing view --}}
	@stack('styles')
</head>
<body>

	{{-- Skrip ini HARUS jadi elemen pertama di <body> supaya class "dark"
	     langsung terpasang sebelum halaman sempat digambar (mencegah flash
	     putih sesaat saat mode gelap aktif). Preferensi disimpan di
	     localStorage sehingga tetap konsisten walau pindah halaman. --}}
	<script>
		(function () {
	...
	{{-- SIDEBAR: diambil dari resources/views/admin/layouts/partials/sidebar.blade.php --}}
...
@yield('content')
	...
	<script>
		...
		switchMode.addEventListener('change', function () {
			if (this.checked) {
				document.body.classList.add('dark');
				localStorage.setItem('adminhub-theme', 'dark');
			} else {
				document.body.classList.remove('dark');
				localStorage.setItem('adminhub-theme', 'light');
			}
		})
		...
		// Pastikan semua menu tertutup di awal
	...
	{{-- JS khusus tiap halaman (modal, filter, dsb), didaftarkan lewat @push('scripts') --}}
	@stack('scripts')
</body>
</html>